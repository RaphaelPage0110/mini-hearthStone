    ...
    public ConcreteSpell createSpell(String nameSpell) {
        ...
        switch(nameSpell) {
            case BENEDICTION_DE_PUISSANCE:
                ...
                concreteSpell = new ConcreteSpell(CardType.PALADIN, 1,  0, abilityKeyword, nameSpell, "https://bit.ly/2Qmsgev", "Rajoute 3 points de dégats à un serviteur");
                break;
            case IMAGE_MIROIR:
                abilityKeyword.put(SUMMON_ABILITY, IMAGE_MIROIR + ", 2");
                concreteSpell = new ConcreteSpell(CardType.MAGE, 1,  0, abilityKeyword, nameSpell, "https://bit.ly/2R7eWzF", "Invoque deux serviteurs 'Image Miroir'");
                break;
            case METAMORPHOSE:
                abilityKeyword.put(TRANSFORM_INTO_ABILITY, MOUTON);
                concreteSpell = new ConcreteSpell(CardType.MAGE, 4, 0, abilityKeyword, nameSpell, "https://bit.ly/2SBLqiu", "Transforme un serviteur en mouton");
                break;
            case EXPLOSION_DES_ARCANES:
                abilityKeyword.put(DAMAGE_ENEMY_MINIONS_ABILITY, "1");
                concreteSpell = new ConcreteSpell(CardType.MAGE, 2,  0, abilityKeyword, nameSpell, "https://bit.ly/2TsvhMi", "Inflige 1 points de dégats aux serviteurs ennemis");
                break;
            case CONSECRATION:
                abilityKeyword.put(DAMAGE_ALL_OPPONENTS_ABILITY, "2");
                concreteSpell = new ConcreteSpell(CardType.PALADIN, 4,  0, abilityKeyword, nameSpell, "https://bit.ly/2SAFiqC", "Inflige 2 points de dégats à tous les adversaires");
                break;
            case TOURBILLON:
                abilityKeyword.put(DAMAGE_ALL_MINIONS_ABILITY, "1");
                concreteSpell = new ConcreteSpell(CardType.WARRIOR, 1,  0, abilityKeyword, nameSpell, "https://bit.ly/2LNnXrW", "Inflige 1 point de dégat à tous les serviteurs");
                break;
            case MAITRISE_DU_BLOCAGE:
                abilityKeyword.put(MODIFY_ARMOR_ABILITY, "5");
                abilityKeyword.put(DRAW_CARD_ABILITY, "1");
                concreteSpell = new ConcreteSpell(CardType.WARRIOR, 3,  0, abilityKeyword, nameSpell, "https://bit.ly/2Vq7RZI", "Rajoute 5 points d'armure et pioche 1 carte");
                break;
            default:
                break;
        }
