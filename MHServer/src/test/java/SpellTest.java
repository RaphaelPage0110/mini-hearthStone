...
public class SpellTest {
    ...
    void setup() {
        ...
        player2.setMyHero(uther); uther.setMyPlayer(player2);
    ...
    void consecrationTest() {
        ...
        assertEquals(chevaucheurDeLoup.getMaxHealthPoints() - 2, chevaucheurDeLoup.getCurrentHealthPoints());
    ...
    void tourbillonTest() {
        ...
        assertEquals(sanglierBrocheroc.getMaxHealthPoints() - 1, sanglierBrocheroc.getCurrentHealthPoints());
    ...
    void maitriseDuBlocageTest() {
        ...
        assertEquals(8, player1.getMyHand().size()); //We add a new card, then spell "maitriseDuBlocage" is remove from hand
